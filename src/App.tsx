...
function App() {
  ...
  const [raceInfo, set_raceInfo] = useState<Race_t>(new Race_t("","","",[],"","",0));
  const [classes, set_classes] = useState<string[]>([]);
  const [classSelected, set_ClassSelected] = useState<string>("");
  const [classInfo, set_classInfo] = useState<Class_t>(new Class_t("",0,[],[]));
    ...
    <div className="App" >
      ...
      <div className='d-flex mx-2'>
        <div className='d-flex row ms-5'>
          ...
          {menu_index === 2 && <Stat abilities={abilities} set_abilities={set_abilities} skills={skills} set_skills={set_skills} savings={savings} set_savings={set_savings} />}
