...
function App() {
  ...
  const [characterDTO, setCharacterDTO] = useState<CharacterDTO_t>(new CharacterDTO_t(1, 1)); // TODO: add real idGame and idPlayer
  const [character, setCharacter] = useState<Character_t>(new Character_t(characterDTO));
